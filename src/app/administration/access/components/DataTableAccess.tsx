...
export default function DataTableAccess<TData, TValue>({ columns, data, buttonAdd }: DataTableProps<TData, TValue>) {
      ...
      <>
        <div className="flex justify-between py-4">
...

            {
              buttonAdd &&
                <Button asChild >
                    <Link href="/administration/access/add"> <Plus/> Agregar nuevo </Link>
                </Button>
            }
        </div>
